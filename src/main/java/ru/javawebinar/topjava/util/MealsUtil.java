...
public class MealsUtil {
    ...
    public static final List<Meal> ADMIN_MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2017, Month.APRIL, 30, 10, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2017, Month.APRIL, 30, 13, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2017, Month.APRIL, 30, 20, 0), "Ужин", 500)
    );
